    ...
    <div className="bg-[#FFA1BF] min-h-screen overflow-x-hidden z-20 md:max-w-[1366px]">
      <div className="relative p-2">
        <img
          src={HEROs}
          alt=""
          className="w-full h-[500px] lg:h-screen object-contain lg:object-cover"
        />
        <div className="absolute inset-x-0 -bottom-[30%] md:-bottom-[32%] md:flex justify-between hidden">
          <img
            src={HERO1}
            alt=""
            className="transform -translate-x-24 h-[400px] lg:flex hidden"
          />
          <img
            src={HERO2}
            alt=""
          ...
          <img
            src={HERO3}
            alt=""
            className="transform translate-x-24 h-[350px] lg:flex hidden"
          />
        </div>
      </div>
      <div className="py-10 bg-[#FF3DB4] px-6 lg:px-20 pt-[100px] md:pt-[350px]">
        <div className="grid lg:grid-cols-2 gap-5 justify-items-center items-center">
          <img
            src={SECTION_1}
            alt=""
            className="md:h-[450px] h-[350px] object-contain lg:object-cover"
          />
      ...
      <div className="py-16 md:py-10 bg-[#FF3DB4] px-6 lg:px-20">
        <div className="grid lg:grid-cols-2 gap-5 justify-items-center items-center">
          ...
          <img
            src={SECTION_2}
            alt=""
            className="h-[450px] object-contain md:col-start-2 md:col-end-3 order-2"
          />
        </div>
      </div>
      ...
      <div className="bg-[#FF3DB4] pt-10 flex flex-col items-center px-6 lg:px-20 pb-10 text-white">
            ...
            <div className="grid w-full h-full grid-cols-1 lg:grid-cols-3 gap-5 py-8 px-6 lg:px-10">
              <div className="flex flex-col items-center">
                ...
                <div className="flex py-2 space-x-2">
                  ...
                  {/* <a href="https//https://t.me/HelloKittyWorldSPL">
                    <FaTelegram />
                  </a> */}
                  <a href="https://t.me/HelloKittyWorldSPL">
                    <FaTelegram />
                  </a>
                  {/* <FaLinkedin /> */}
                </div>
        ...
        <div className="hidden md:relative w-full h-[200px]">
          <img
            src={FOOTER}
            alt=""
            className="object-contain h-[150px] w-[150px] absolute right-0 bottom-[65px]"
          />
        </div>
      </div>
    </div>
